...
def timing():
    ...
    min_time_next_event = 1.0 * 10**29
    next_event_type = 0
    for i in range(num_events):
        print(time_next_event[i+1])
...
def report():
    ...
    output_file.write("Number of delays completed  {0}".format(num_custs_delayed))


def expon(mean):
    rand = random.uniform(0.000000000000001, 1.0)

def report():
    global total_of_delays, num_customers_delayed, area_num_in_queue, area_server_status, sim_time
    # Compute and write estimates of desired measures of performance
    average_delay_in_queue = total_of_delays / num_customers_delayed

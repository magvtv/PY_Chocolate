...
def report():
    ...
    avg_d_q.append(total_of_delays/num_custs_delayed)
    avg_n_q.append(area_num_in_queue/simulation_time)
...
def report_print():
    ...
    data = {
        "Average delay in queue" : avg_d_q,
        "Average no in queue"    : avg_n_q,
        "Server Utilization"     : srvr_utilize,
        "Time Simulation ended"  : sim_ended
    }
